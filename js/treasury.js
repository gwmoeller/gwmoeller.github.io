...
function start() {
	$.when(
		...
		$.getJSON(url_5),
			...
			var guildWorkshop = ["Ore Synthesizer 1", "Ore Synthesizer 2", "Lumber Synthesizer 1", "Lumber Synthesizer 2", "Plant Synthesizers 1", "Leather Synthesizer 1", "Leather Synthesizer 2", "Cloth Synthesizer 1", "Cloth Synthesizer 2", "Synthesis 1", "Synthesis 2", "Critical Harvesting", "Critical Crafting", "Map Bonus", "Ore Synthesizer 3", "Ore Synthesizer 4", "Ore Synthesizer 5", "Ore Synthesizer 6", "Lumber Synthesizer 3", "Lumber Synthesizer 4", "Lumber Synthesizer 5", "Plant Synthesizers 2", "Plant Synthesizers 3", "Leather Synthesizer 3", "Leather Synthesizer 4", "Leather Synthesizer 5", "Cloth Synthesizer 3", "Cloth Synthesizer 4", "Cloth Synthesizer 5", "Synthesis 3", "Synthesis 4"];
			var guildWarRoom = ["Mission Slot: WvW", "Claim Camps", "Claim Towers", "Aura 1 Supply", "Aura 2 XP", "Aura 3", "Reward Tracks", "WvW Experience", "Minor Supply Drop", "Sabotage Depot", "Chilling Fog", "Armored Dolyaks", "Arrow Cart", "Invincible Dolyak", "Ballista", "Speedy Dolyaks", "Iron Guards", "Turtle Banner", "Catapult", "Claimed Keeps", "Stonemist Castle", "Aura 4", "Aura 5", "Aura 6", "Aura 7", "Aura 8", "Assault Roller", "Hardened Gates", "Hardened Siege", "Centaur Banner", "Packed Dolyaks", "Flame Ram", "Dragon Banner", "Invulnerable Fort", "Trebuchet", "Emergency Waypoint", "Turret Gates", "Golem", "Watchtower", "Presence of the Keep", "Shield Generator", "Cloaking Waters", "Airship Defense"];
